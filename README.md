...
## 🚀 Features
- Generate barcode images using **ZXing**
- Print barcodes directly to any installed printer
- Lightweight — no installation required
- Works from command line with simple arguments

---

## 🛠️ Technologies Used
- **C# (.NET)**
- **ZXing.Net** (barcode generation package)
